...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "email" | "username" | "password" | "provider" | "providerId" | "refreshToken" | "createdAt", ExtArgs["result"]["user"]>
  ...
  export type TextOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "text" | "audioUrl" | "userId" | "createdAt", ExtArgs["result"]["text"]>
  ...
  export interface Prisma__TextClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    user<T extends Text$userArgs<ExtArgs> = {}>(args?: Subset<T, Text$userArgs<ExtArgs>>): Prisma__UserClient<$Result.GetResult<Prisma.$UserPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | null, null, ExtArgs, GlobalOmitOptions>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface TextFieldRefs {
    ...
    readonly audioUrl: FieldRef<"Text", 'String'>
  ...
  export type TextWhereInput = {
    ...
    audioUrl?: StringNullableFilter<"Text"> | string | null
    userId?: StringNullableFilter<"Text"> | string | null
  ...
  export type TextScalarWhereWithAggregatesInput = {
    ...
    audioUrl?: StringNullableWithAggregatesFilter<"Text"> | string | null
    userId?: StringNullableWithAggregatesFilter<"Text"> | string | null
  ...
  export type TextCreateInput = {
    ...
    audioUrl?: string | null
    createdAt?: Date | string
    user?: UserCreateNestedOneWithoutTextsInput
  }
  ...
  export type TextUpdateInput = {
    ...
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    user?: UserUpdateOneWithoutTextsNestedInput
  }
  ...
  export type UserCreateNestedOneWithoutTextsInput = {
    ...
    connectOrCreate?: UserCreateOrConnectWithoutTextsInput
    connect?: UserWhereUniqueInput
  }

  export type UserUpdateOneWithoutTextsNestedInput = {
    create?: XOR<UserCreateWithoutTextsInput, UserUncheckedCreateWithoutTextsInput>
    connectOrCreate?: UserCreateOrConnectWithoutTextsInput
    ...
    connect?: UserWhereUniqueInput
    update?: XOR<XOR<UserUpdateToOneWithWhereWithoutTextsInput, UserUpdateWithoutTextsInput>, UserUncheckedUpdateWithoutTextsInput>
  }
